...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (
            ...
            $newUploadPath = $uploadDirectory . $newFileName;

            if (!move_uploaded_file(
                $_FILES['image']['tmp_name'],
                $newUploadPath
            )) {
                $errors[] = 'Unable to save the new product image.';
            } else {
        ...
        if (empty($errors)) {
            try {
                ...
                if (
                    $newImageUploaded &&
                    !empty($currentImage) &&
                    file_exists('../assets/' . $currentImage)
                ) {
                    unlink('../assets/' . $currentImage);
                }
                ...
                $errors[] = 'Unable to update the product. Please try again.';
            }
        }
    }
}
...
<head>
    ...
    <title>BBN BITES | Edit Product</title>
                ...
                <div class="admin-form-group">
                    ...
                    <?php if (!empty($currentImage)): ?>
                        ...
                        <div class="admin-current-image">
                            ...
                            <img
                                src="../assets/<?= htmlspecialchars($currentImage) ?>"
